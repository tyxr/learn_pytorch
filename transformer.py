...
class SublayerConnection(nn.Module):
    ...
    def forward(self, x, sublayer):
        "Apply residual connection to any sublayer with the same size."#把输出处理一下再跟输入加起来
...
def example_two():
    ...
    if True:
        ...
        criterion.cuda()
        BATCH_SIZE = 1200#12000
        train_iter = MyIterator(train, batch_size=BATCH_SIZE, device=ddd,
